  ...
  render () {
    return [
      ...
      <div class="carousel carousel-slider center index-cover" data-indicators="true">
                  ...
                  <div class="description center-align">
                    ...
                    <script>
                      var typed = new Typed("#subtitle", {
                        strings: [
                        '从来没有真正的绝境, 只有心灵的迷途', 'Never really desperate, only the lost of the soul'
                      ],
                      startDelay: 300,
                      typeSpeed: 100,
                      loop: true,
        ...
        <div class="carousel-item amber white-text carousel-post bg-cover" style="background-image: url('/medias/featureimages/9.jpg');">
          <div class="container">
            <div class="row">
              <div class="col s10 offset-s1">
                ...
                <div class="description center-align">
                  English Document | 演示示例 | QQ交流群:926552981 这是一个采用Material Design和响应式设计的 Hexo 博客主题。 特性 简单漂亮，文章内容美观易读 Material Design 设计
       </div>
                <div class="cover-btns">
                  <a href="/2018/09/28/qian-duan/hexo-bo-ke-zhu-ti-zhi-hexo-theme-matery-de-jie-shao/" class="waves-effect waves-light btn" target="_blank">
                    <i class="icon fa fa-eye fa-fw"></i>阅读更多 </a>
                </div>
              </div>
            </div>
          </div>
                ...
                <script>
                  $(function () {
                    new DPlayer({
                      ...
                      volume: Number('0.7'),
                      video: {
                        url: '/medias/videos/demo.mp4',
                        pic: '/medias/videos/demo-pic.png',
                        thumbnails: ''
                      }
                    });
                });
      ...
      <footer class="page-footer bg-color">
        <div class="">
          <div class="row">
            <meting-js class="col l8 offset-l2 m10 offset-m1 s12" server="netease" type="playlist" id="503838841" fixed="true" autoplay="false" theme="#42b983" loop="all" order="random" preload="auto" volume="0.7" list-folded="true"></meting-js>
          </div>
        </div>
